...
export function toOrderDto(doc: OrderDocument) {
  return {
    ...
    shippingAddress: {
      ...
      receiverName: doc.shippingAddress.receiverName,
      receiverPhone: doc.shippingAddress.receiverPhone,
      houseNo: doc.shippingAddress.houseNo,
      building: doc.shippingAddress.building,
      area: doc.shippingAddress.area,
      landmark: doc.shippingAddress.landmark,
